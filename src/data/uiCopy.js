const uiCopy = {
  es: {
    localeLabel: 'Idioma',
    projectTitle: 'Plataforma colaborativa para la historia del cancer de mama',
    projectFocus:
    ...
    loadingEyebrow: 'Plataforma de investigacion',
    loadingTitle: 'Cargando corpus, menciones y vectores contextuales.',
    heroEyebrow: 'Plataforma de investigacion cientifica',
    heroNote:
      'El foco del estudio esta fijado en el corpus completo: localizar todos los archivos donde aparece el vocabulario historico del cancer de mama, comparar coincidencias entre menciones y dejar trazable que parte viene de lectura humana, que parte de reglas simples y que parte de vectorizacion contextual.',
    studySectionLabel: 'Perfil del estudio',
    evaName: 'Eva Guadalupe Hernández Avilez',
    evaBioLabel: 'Bio',
    evaBio:
      'Eva Guadalupe Hernández Avilez coordina la lectura visual de textos digitalizados, la ampliacion del lexico historico y la interpretacion de hallazgos dentro de este proyecto.',
    purposeLabel: 'Proposito',
    purposeTitle: 'Proposito del estudio',
    purpose:
      'Reconstruir colaborativamente como se nombro, describio, trato, reporto y valoro economicamente el cancer de mama antes de 1900, siguiendo la historia y evolucion de las palabras en fuentes medicas, populares y archivisticas.',
    uploadCallout: 'La plataforma ya permite subir documentos y OCR para que Eva y la comunidad amplien el corpus.',
    ...
    stats: {
      ...
      configuredTerms: 'terminos configurados',
    ...
    band: {
      sectionLabel: 'Marco metodologico',
      title: 'Lo que ya sabemos y como se produce',
      text:
        'Ya hay coincidencias detectadas en el corpus semilla: terminos, sintomas, cirugia, puerperio y relaciones entre documentos. La plataforma ahora muestra esas coincidencias como estado del corpus y no como una consulta aislada. A la vez, abajo queda una capa de prospeccion con muchos mas documentos localizados pero todavia no curados.',
      loading: 'actualizando corpus',
      ready: 'corpus sincronizado',
    },
    algorithms: {
      sectionLabel: 'Capas de analisis',
      title: 'Manual, heuristico y vectorial',
      text:
        'La lectura exacta y el lexico curado siguen siendo la base. Encima de eso corren heuristicas de agrupacion y una capa vectorial TF-IDF para contextos similares.',
      cards: [
        {
          tier: 'Manual + exacto',
          title: 'Lexico curado por investigacion',
          description:
            'Eva y la comunidad agregan terminos y variantes historicas. Esta capa equivale a una inspeccion documental controlada y trazable.',
        },
        {
          tier: 'Heuristico simple',
          title: 'Coincidencias y coocurrencias',
          description:
            'Agrupamos menciones por documento, tramo y decada para ver donde se repiten combinaciones de vocabulario y sintomas.',
        },
        {
          tier: 'Vectorizacion actual',
          title: 'TF-IDF contextual',
          description:
            'Cada fragmento del corpus se vectoriza para comparar contextos cercanos por distribucion de palabras, no solo por coincidencia literal.',
        },
        {
          tier: 'Siguiente capa',
          title: 'Embeddings y alineacion semantica',
          description:
            'La siguiente etapa puede sumar embeddings multilingues, entidades historicas y agrupamientos tematicos para corpus mas grandes.',
        },
      ],
    },
    controls: {
      sectionLabel: 'Exploracion del corpus',
      title: 'Filtrar menciones y coincidencias',
      text:
        'Esta capa no busca una sola palabra. Filtra el conjunto de menciones ya detectadas en todo el corpus para ver donde se concentra la evidencia.',
      queryLabel: 'Consulta de trabajo',
      queryPlaceholder: 'p. ej. ulcerated breast, surgery, lying-in',
      configuredTerm: 'Termino configurado',
    ...
    visuals: {
      timelineTitle: 'Cronologia de documentos con menciones',
      timelineSubtitle:
      ...
      topTermsTitle: 'Terminos mas presentes',
      topTermsSubtitle:
        'Las frecuencias salen de todas las menciones visibles bajo los filtros actuales.',
      topTermsMetric:
        'Cada barra indica cuantas veces aparece el termino configurado en las menciones filtradas.',
      cooccurrenceTitle: 'Coocurrencias mas fuertes',
      cooccurrenceSubtitle: 'Pares de terminos que aparecen juntos dentro del mismo fragmento.',
      cooccurrenceMetric:
        'Esto sirve para detectar constelaciones de sintomas, tratamientos o nomenclaturas.',
      summaryLabel: 'Coincidencias ya detectadas',
      summaryTitle: 'Estado actual del corpus',
      sharedFragments: 'fragmentos comparten esta relacion.',
      networkTitle: 'Mapa termino-obra',
      networkSubtitle:
        'Izquierda: terminos historicos. Derecha: obras donde aparecen. El grosor de la linea indica peso de la relacion.',
      networkEmpty: 'Aun no hay suficientes menciones filtradas para dibujar la red.',
      chartHint: 'La grafica puede desplazarse en pantallas pequenas.',
      networkHint:
        'Arrastra nodos si quieres reorganizar la lectura. La estructura base ya separa terminos y obras.',
    },
    mentions: {
      sectionLabel: 'Menciones detectadas',
      title: 'Pruebas textuales',
      summary:
        'Selecciona una mencion para ver su contexto y los fragmentos vectorialmente parecidos.',
      empty:
        'No hay menciones para los filtros actuales. Prueba otra categoria, otro tipo de fuente o agrega nuevos terminos al lexico.',
      activeLabel: 'Mencion activa',
      noSelection: 'Sin seleccion',
      noActive: 'No hay una mencion activa para mostrar.',
      similarLabel: 'Contextos similares',
      similarTitle: 'Comparacion vectorial desde la mencion',
      similarNote:
        'Aqui ya no se exige la misma palabra. Se comparan distribuciones de vocabulario en fragmentos cercanos del corpus.',
      comparing: 'Comparando contextos…',
      noNeighbors:
        'Esta mencion aun no devuelve vecinos contextuales suficientemente cercanos.',
      ...
      evaLabPlaceholder:
        'Pega aqui el fragmento que Eva quiera comparar contra el corpus.',
      evaLabButton: 'Comparar contexto',
      evaLabButtonLoading: 'Comparando…',
    },
    lexicon: {
      sectionLabel: 'Estudio del lexico',
      title: 'Configurar terminos y variantes',
      text:
        'Eva puede incorporar nuevas formulas historicas a partir de la inspeccion visual del texto digital. Esos terminos entran de inmediato al analisis del corpus.',
      editButton: 'Editar',
      noMethodNote: 'Sin nota metodologica.',
      editTitle: 'Editar termino',
      newTitle: 'Agregar termino nuevo',
      cancelEdit: 'Cancelar edicion',
      canonical: 'Forma canonica',
      category: 'Categoria',
      variants: 'Variantes historicas',
      variantsPlaceholder: 'Una por coma o por linea.',
      notes: 'Nota de investigacion',
      notesPlaceholder: 'Por que este termino importa y como se usa historicamente.',
      saveNew: 'Agregar termino',
      saveEdit: 'Actualizar termino',
      saving: 'Guardando…',
    },
    upload: {
      ...
      text:
        'El mismo formulario sirve para Eva y para la comunidad. Se puede subir un archivo escaneado, pegar OCR y dejar metadatos minimos para que el documento entre al flujo de investigacion.',
      fieldTitle: 'Titulo',
      ...
      recordTypePlaceholder: 'manual, prensa, registro medico, revista',
      sourceHost: 'Repositorio o procedencia',
      contributorName: 'Quien carga',
      contributorRole: 'Rol',
      contributorRolePlaceholder: 'Eva, comunidad, archivo',
      file: 'Archivo escaneado o transcrito',
      summary: 'Resumen curado',
      summaryPlaceholder: 'Que es el documento y por que importa.',
      notes: 'Notas de catalogacion',
      notesPlaceholder: 'Estado del OCR, problemas paleograficos, dudas.',
      ocrText: 'OCR o transcripcion en texto',
      ocrPlaceholder: 'Pega aqui el texto digitalizado para que entre directo a analisis.',
    ...
    connected: {
      ...
      text:
        'Este listado sirve como reporte operativo de donde ya aparecio el vocabulario historico dentro del corpus.',
      mentionsSuffix: 'menciones',
    },
    prospecting: {
      sectionLabel: 'Prospeccion masiva',
      title: 'Fuentes nuevas localizadas para incorporar',
      text:
        'Esta lista no esta curada todavia dentro del corpus principal. Son documentos ya rastreados en archivos digitales, listos para priorizar, descargar OCR y pasar al flujo editorial.',
      source: 'fuente',
    ...
    messages: {
      ...
      termSaveError: 'No se pudo guardar el termino.',
      termUpdated: 'Termino actualizado en el lexico.',
      termCreated: 'Nuevo termino agregado al corpus.',
